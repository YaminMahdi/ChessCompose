...
public val Chess.`Bishop-b`: ImageVector
    get() {
        if (`_bishop-b` != null) {
            return `_bishop-b`!!
        }
        `_bishop-b` = Builder(name = "Bishop-b", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp,
...
private var `_bishop-b`: ImageVector? = null
